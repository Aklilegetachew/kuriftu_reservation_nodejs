            ...
            qr.toFile(
              ...
              async function (err, code) {
                ...
                if (user.location == "waterpark") {
                  ...
                  subject =
                    "You've successfully purchased Kuriftu Water Park ticket";
                  template = "waterpark";
                  ...
                  from = "Boston Day Spa";
                  subject =
                    "You've successfully purchased Boston Day Spa ticket";
                  template = "boston";
                }
                ...
                emailSent = {
                  ...
                  "v:expDate": dateFunction(
                    user.createdAt.setMonth(user.createdAt.getMonth() + 3)
                  ),
                  attachment,
                };
